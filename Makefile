...
all:
	...
	$(_V)$(PYTHON) "bin/romdiffs.py" -a "orig" -b "$(BUILD)" "ViewSheet vB1.0 [variant 1].rom" "ViewSheet vB1.0 [variant 2].rom" "ViewSheet vB1.0 [variant 3].rom" "Master MOS v3.50 - ViewSheet vB1.01.rom" "ViewSheet v1.0 [variant 3].rom" "Olivetti Prodest PC128S - ViewSheet vI1.1.rom"
